...
1. run [https://github.com/meringlab/FlashWeave.jl](FlashWeave) using abundance & metadata tables to build co-occurrence network
2. get the NCBI Taxon id of each taxon present in the edge file
3. build a database with the KOs search for available reference genomes for these ids 
