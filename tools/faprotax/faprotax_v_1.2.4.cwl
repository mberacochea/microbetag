...
requirements:
  ResourceRequirement:
    coresMin: 2
    ramMin: 95 # Modified to testing

# The container ideally should be in quay or dockerhub, faprotax:testing is the name I use locally for testing
# cd tools/faprotax && docker build -t faprotax:testing .
hints:
  DockerRequirement:
    dockerImageId: "faprotax:testing"
